...
AUTO_IGNORE_NUM_ASES_INFECTED = os.getenv("AUTO_IGNORE_NUM_ASES_INFECTED", 0)
AUTO_IGNORE_NUM_PEERS_SEEN = os.getenv("AUTO_IGNORE_NUM_PEERS_SEEN", 0)
AUTO_IGNORE_INTERVAL = os.getenv("AUTO_IGNORE_INTERVAL", 0)
