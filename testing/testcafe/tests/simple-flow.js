...
test('Simple Flow', async t => {
    await t
        ...
        .expect(Selector('li').withText('Bgpstreamkafkatap').textContent).contains("Bgpstreamkafkatap On 0/1")
        ...
        .expect(Selector('li').withText('Prefixtree').textContent).contains("Prefixtree On 1/1")
        .expect(Selector('li').withText('Riperistap').textContent).contains("Riperistap On 0/1")
        .expect(Selector('#db_stat_value_monitored_prefixes').find('b').withText('3').textContent).eql("3")
        .expect(Selector('#db_stat_value_configured_prefixes').find('b').withText('5').textContent).eql("5")
        ...
        .expect(Selector('#module_riperistap_instances_running').find('button').withText('Active 0/1').textContent).eql(" Active 0/1")
        .expect(Selector('#module_bgpstreamlivetap_instances_running').find('button').withText('Active 0/1').textContent).eql(" Active 0/1")
        .expect(Selector('#module_bgpstreamkafkatap_instances_running').find('button').withText('Active 0/1').textContent).eql(" Active 0/1")
        .expect(Selector('#module_bgpstreamhisttap_instances_running').find('button').withText('Active 0/1').textContent).eql(" Active 0/1")
        .expect(Selector('#module_exabgptap_instances_running').find('button').withText('Active 0/1').textContent).eql(" Active 0/1")
