...
class TestConfParser(unittest.TestCase):
    ...
    def test_valid_conf(self):
        ...
        self.assertEqual(group1['prefixes'], {ipaddress.ip_network('10.0.0.0/24'), ipaddress.ip_network('20.0.0.0/24')})
        ...
        self.assertEqual(prefixes_group['forth_prefixes'], {ipaddress.ip_network('10.0.0.0/24'), ipaddress.ip_network('20.0.0.0/24')})
        self.assertEqual(prefixes_group['sample_prefixes'], {ipaddress.ip_network('30.0.0.0/24')})
        ...
        self.assertEqual(exabgp, {('192.168.1.1', 5000), ('192.168.5.1', 5000)})
    ...
    def test_process_field_prefixes(self):
        ...
        self.assertEqual(prefixes, {ipaddress.ip_network('1.0.0.0/24'), ipaddress.ip_network('2.0.0.0/24')})
        ...
        self.assertEqual(prefixes, {ipaddress.ip_network('10.0.0.0/24'), ipaddress.ip_network('20.0.0.0/24'), ipaddress.ip_network('30.0.0.0/24')})
    ...
    def test_process_field_asns(self):
        ...
        self.assertEqual(asns, {123,321,1})
