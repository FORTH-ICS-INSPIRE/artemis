...
class HijackTable(Table):
    ...
    mitigate = ButtonCol('Mitigate', 'main.mitigate_hijack', url_kwargs=dict(id='id'))
    resolved = ButtonCol('Resolved', 'main.resolved_hijack', url_kwargs=dict(id='id'))
    allow_sort = True
